...
• Hesabı Sil: Ayarlar > Hesabı Sil adımını izlediğinizde, kimlik doğrulaması bağlı hesabınız ve tüm ilişkili veriler sistemimizden kalıcı olarak silinir.

• Veriyi Sil: Ayarlar > Veriyi Sil adımı, hesabınızı koruyarak araçlar, bakım, yakıt ve diğer kayıtlarınızın tamamını kalıcı olarak siler.

• Geri Alınamaz: Silme işlemleri geri alınamaz. İsterseniz işlem öncesi Profil > PDF Raporu ile verilerinizi dışa aktarabilirsiniz.

• Güvenlik ve Erişim: Verileriniz uygulama içinde şifrelenmiş olarak tutulur; yasal zorunluluklar dışında içeriğe erişim mümkün değildir. Bu nedenle, biz dahi verilerinize bakamayız.
